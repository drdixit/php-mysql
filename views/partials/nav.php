            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="/" class="<?php echo urlIs('/') ? 'bg-gray-900 text-white' : 'text-gray-300'; ?> rounded-md px-3 py-2 text-sm font-medium hover:bg-gray-700 hover:text-white">Home</a>
                        <a href="/about" class="<?php if($_SERVER['REQUEST_URI'] === '/about') {echo 'bg-gray-900 text-white'; } else { echo 'text-gray-300'; } ?> rounded-md px-3 py-2 text-sm font-medium hover:bg-gray-700 hover:text-white">About</a>
                        <a href="/notes" class="<?php if($_SERVER['REQUEST_URI'] === '/notes') {echo 'bg-gray-900 text-white'; } else { echo 'text-gray-300'; } ?> rounded-md px-3 py-2 text-sm font-medium hover:bg-gray-700 hover:text-white">Notes</a>
